...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ThePrem | Building Products People Love" },
      {
        name: "description",
        content:
          "Official website of Prem Prasad showcasing AI products, productivity tools, and digital experiences built under ThePrem.",
      },
      { name: "author", content: "Prem Prasad" },
      { property: "og:title", content: "ThePrem | Building Products People Love" },
      {
